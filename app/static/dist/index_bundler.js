...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Volumes/Z77ExtremeHDD/Users/dhocker/Source/flask-react/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Volumes/Z77ExtremeHDD/Users/dhocker/Source/flask-react/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	*/
	function initHomePage() {
	    ...
	    var authorTableColumns = [{ colname: 'LastName', label: 'Last Name' }, { colname: 'FirstName', label: 'First Name' }, { colname: 'category', label: 'Category' }, { colname: 'try_author', label: 'Try' }, { colname: 'Avoid', label: 'Avoid' }, { colname: 'id', label: 'ID' }];
	
	    console.log("Attempting to create Table");
	    _reactDom2.default.render(_react2.default.createElement(_table2.default, { 'class': "table table-striped table-condensed",
	...
	*/
	function initFormPage() {
	    ...
	    var formform = _react2.default.createElement(_form2.default, null);
	    _reactDom2.default.render(_react2.default.createElement(_form2.default, null), document.querySelector('#reactform'));
	    console.log("Form class created");
	};
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Volumes/Z77ExtremeHDD/Users/dhocker/Source/flask-react/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "main.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	...
	*/
	...
	var Form = function (_React$Component) {
	    ...
	    function Form(props) {
	        ...
	        _this.helloChanged = _this.helloChanged.bind(_this);
	        _this.worldChanged = _this.worldChanged.bind(_this);
	        _this.save = _this.save.bind(_this);
	        _this.checkChanged = _this.checkChanged.bind(_this);
	        _this.optionChanged = _this.optionChanged.bind(_this);
	        _this.selectChanged = _this.selectChanged.bind(_this);
	        return _this;
	    }
	
	    _createClass(Form, [{
	        key: 'helloChanged',
	        value: function helloChanged(event) {
	            this.state['helloValue'] = event.target.value;
	        }
	    }, {
	        key: 'worldChanged',
	        value: function worldChanged(event) {
	            this.state['worldValue'] = event.target.value;
	        }
	    }, {
	        key: 'checkChanged',
	        value: function checkChanged(event) {
	            this.setState({ checkValue: !this.state.checkValue });
	        }
	    }, {
	        key: 'optionChanged',
	        value: function optionChanged(event) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('input', { id: 'hello', type: 'text', className: 'form-control', onChange: this.helloChanged })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'form-group' },
	                            ...
	                            _react2.default.createElement('input', { id: 'world', type: 'text', className: 'form-control', onChange: this.worldChanged })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'form-group' },
	                            ...
	                            _react2.default.createElement(_select2.default, { id: 'select', 'class': 'form-control', options: ["s1", "s2", "s3"],
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'label',
	                                null,
	                                _react2.default.createElement('input', { type: 'checkbox', checked: this.state.checkValue, onChange: this.checkChanged
	                                }),
	                                'Check me out'
	                            )
	                        ),
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'label',
	                                        null,
	                                        _react2.default.createElement('input', { type: 'radio', name: 'optionsRadios', id: 'optionsRadios1',
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'label',
	                                        null,
	                                        _react2.default.createElement('input', { type: 'radio', name: 'optionsRadios', id: 'optionsRadios2',
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { id: 'save', type: 'button', className: 'btn btn-primary', onClick: this.save },
	                            'Save'
	                        )
	                    )
	                )
...
/***/ }
/******/ ]);
//# sourceMappingURL=index_bundler.js.map