...
export default class NewCategoryForm extends React.Component {
    ...
    */
    commitCategory(http_verb, url, data) {
        // The data object will be request.form on the server
        const $this = this;
        this.serverRequest = $.ajax({
            ...
            success: function (result) {
                ...
                if (http_verb === "POST") {
                    ...
                    $this.setState({message: "Category added"});
                }
                else {
                    console.log("Category saved");
                    $this.setState({message: "Category saved"});
                }
           },
            error: function (xhr, status, errorThrown) {
                ...
                // Show user error
                const errormsg = "That category already exists: " + $this.state.nameValue;
